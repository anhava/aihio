          ...
          <div className="row g-5">
            ...
            <div className="col-xl-4 col-lg-7 col-md-9 me-auto order-xl-first">
              <TextWidget
                ...
                logoWidth="125"
                logoHeight="26"
                title="Säästä aikaa. Tehosta tuottavuutta."
                subTitle="Luo automaattisesti blogiartikkeleita, verkkosivutekstejä, 
                ja tehosta digitaalista markkinointia yrityksellesi sekunneissa. 
                Vapauta kehittynein tekoälykirjoittaja lisätäksesi liikennettäsi ja tuottavuuttasi."
              />
              <Copyright
                copyrightText="Copyright © 2024"
                copyrightLink="https://aihio.ai"
                copyrightLinkText="Aihio.ai"
