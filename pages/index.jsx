...
export default function HomeS5() {
  return (
    <>
      <Head>
        <title>
          Aihio.ai - Kirjoita markkinointitekstejä ja sisältöä tekoälyllä
        </title>
      </Head>
      <Layout5>
        <HeroStyle5
          upTitle="Aihio.ai - Vapauta tekoälyn voima"
          title="Luo uskomattomia <span className='text-gradient-primary'>verkkosisältöpostauksia</span> 10X nopeammin tekoälyn avulla."
          subTitle="Tyylikkäästi rakennettua sisältöä vain muutamalla napsautuksella."
          bnt1Text="Rekisteröidy Google-tilillä"
          btn1Url="/"
          btn2Text="Rekisteröidy sähköpostiosoitteella"
          btn2Url="/register"
          alertMessage="<strong>*100% ilmainen</strong> rekisteröityminen ja käyttöönotto. Luottokorttia ei tarvita."
        ...
        <section className="section section-lg section-bottom-0">
          <div className="container">
            <Brands
              ...
              actionBtnUrl="/login"
              actionBtnText="Aloita ilmainen kokeilujakso"
            />
          </div>
        </section>
        <section className="section section-lg section-bottom-0">
